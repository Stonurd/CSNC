...
public static final RegistryObject<FluidType> HONEY_FLUID_TYPE1 = FLUID_TYPE_REG.register("honey", ()
        -> new HoneyFluidType(FluidType.Properties.create().lightLevel(1).density(2048).viscosity(4906).temperature(300).pathType(BlockPathTypes.LAVA)
...
public static final RegistryObject<FluidType> INK_FLUID_TYPE1 = FLUID_TYPE_REG.register("ink", ()
        -> new InkFluidType(FluidType.Properties.create().lightLevel(0).density(16).viscosity(32).temperature(300).pathType(BlockPathTypes.WATER)
...
public static final RegistryObject<FluidType> CARAMEL_FLUID_TYPE1 = FLUID_TYPE_REG.register("caramel", ()
        -> new CaramelFluidType(FluidType.Properties.create().lightLevel(1).density(2048).viscosity(4906).temperature(300).pathType(BlockPathTypes.LAVA)
                .sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY_LAVA).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL_LAVA)
        ));
...
public static final RegistryObject<FluidType> FRYING_OIL_FLUID_TYPE1 = FLUID_TYPE_REG.register("frying_oil", ()
        -> new CaramelFluidType(FluidType.Properties.create().lightLevel(1).density(1024).viscosity(1024).temperature(300).pathType(BlockPathTypes.LAVA)
                .sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL)
        ));
...
public static final RegistryObject<FluidType> SLIME_FLUID_TYPE1 = FLUID_TYPE_REG.register("slime", ()
        -> new CaramelFluidType(FluidType.Properties.create().lightLevel(1).density(1024).viscosity(2048).temperature(300).pathType(BlockPathTypes.LAVA)
                .sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY_LAVA).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL_LAVA)
        ));
...
public static final RegistryObject<FlowingFluid> SLIME_FLUID_FLOWING1 = FLUID_REG.register("frying_oil_flowing", () -> new ForgeFlowingFluid.Flowing(slimeProperties()));
